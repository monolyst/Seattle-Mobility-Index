...
#shapefile filepath
    ...
    FP = os.path.join(os.pardir, os.pardir, 'seamo/data/raw/shapefiles/', desired_geometry)
...
def main():
    ...
    ### Neighborhood
    neighborhoods = process_data('neighborhood', 'NEIGHBORHO', crs, outline, rectangle)

    ### Council District
    coucil_districts = process_data('sccdst', 'NAME', crs, outline, rectangle)

    ### Zipcode
    zipcodes = process_data('zipcode', 'ZIPCODE', crs, outline, rectangle)

    ### Urban Village
    urban_villages = process_data('DPD_uvmfg_polygon', 'UV_NAME', crs, outline, rectangle)    
