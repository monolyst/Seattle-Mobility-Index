...
# -*- coding: utf-8 -*-
#
# seamo documentation build configuration file, created by
...
latex_documents = [
  ('index', 'seamo.tex', 'seamo Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'seamo', 'seamo Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'seamo', 'seamo Documentation',
   'Ariel Rokem', 'seamo', 'One line description of project.',
   'Miscellaneous'),
]
