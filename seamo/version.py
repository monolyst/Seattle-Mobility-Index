...
description = "seamo: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/seamo/blob/master/README.md

License
=======
``seamo`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/seamo"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
